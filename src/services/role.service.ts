...
export async function assignRandomTeam(member:GuildMember) {
	...
	const owlMsg = ("<:teamOwls:870144665427533857> With Celeste and Blathers by your side, I'm sure you can discover greatness! Your team strives for Knowledge and Truth.");
    const nookMsg = ("<:teamNooklings:870144665557532733> With Timmy and Tommy by your side, I'm sure you can sell out the competition! Your team is all about Community and Growth.");
    const hedgeMsg = ("<:teamHedgehogs:870144665532379238> With Mabel, Sable, and Label by your side, I'm sure you can design your own paths! Your team lives for Innovation and Creativity");
    const dodoMsg = ("<:teamDodos:870144665691762708> With Orville and Wilbur by your side, I'm sure you can fly to great heights! Your team is all for Exploration and Adventure.");
  ...
  "fields": [
    ...
    {
      "name": "Suggestions",
      "value": "If there is something you want to see in the server, do not hesitate to send a message in <#852316816940335144>. After staff review it can be voted on by the community!",
      "inline": false
    }
  ]
}]}).catch(console.error);
